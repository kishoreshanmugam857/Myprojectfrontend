		...
		<div class="row">
			...
			<div class="col-md-6 login-form">
				...
				<form>
					...
					<div class="form-group">
						<button type="button" class="btn btn-primary btn-lg btn-block">Sign
							In</button>
					</div>
