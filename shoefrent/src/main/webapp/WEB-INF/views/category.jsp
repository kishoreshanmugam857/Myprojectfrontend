	...
	<div class="container">
		<div class="row main">
			<div class="main-login main-center">
				...
				<form:form class="form-group" modelAttribute="categorymodel">
						...
						<div class="cols-sm-10">
							<div class="input-group">
								...
								<form:input type="text" class="form-control" name="name"
									id="name" placeholder="Enter category name" path="cat_name" />
							</div>
						</div>
					</div>
						...
						<div class="cols-sm-10">
							<div class="input-group">
								...
								<form:input type="text" class="form-control" name="email"
									id="email" placeholder="Enter description" path="cat_desp" />
							</div>
						</div>
					</div>
					...
					<div class="form-group ">
						<a href="https://deepak646.blogspot.com/" target="_blank"
							...
							class="btn btn-primary btn-lg btn-block login-button">add</a>
					</div>
